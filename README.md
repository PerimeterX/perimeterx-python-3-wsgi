...
> Latest GAE stable version: [v1.0.0](https://pypi.org/project/perimeterx-python-3-wsgi-gae/)
...
* Standalone: `pip install -U perimeterx-python-3-wsgi`
* Google App Engine: `pip install -t lib/ -U perimeterx-python-3-wsgi-gae`
